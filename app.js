...
const indexRoute      = require("./routes/index"),
      ...
      ideaRoute   = require("./routes/idea");

// connect to the DB
let url = process.env.DATABASEURL || "mongodb://localhost/yelp_camp"; // fallback in case global var not working
...
app.use("/campground/idea",ideaRoute);
